...
with open(ped_file) as ped, open(aDNA_ped_file,"w") as output:
    ...
    for index,ind in enumerate(ped):
        ...
        if new_index == 51:
            ...
            PERCENTAGE = 10
        elif new_index > 10 and new_index < 21:
            PERCENTAGE = 20
            #print(new_index, PERCENTAGE)
        elif new_index > 20 and new_index < 31:
            PERCENTAGE = 30
            #print(new_index, PERCENTAGE)
        elif new_index > 30 and new_index < 41:
            PERCENTAGE = 40
            #print(new_index, PERCENTAGE)
        elif new_index > 40 and new_index < 51:
            PERCENTAGE = 50
            #print(new_index, PERCENTAGE)
        ...
        #Now focusing on only the genetic infomation
